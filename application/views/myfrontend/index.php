<!-- banner start -->
					...
					<div class="slider-revolution-5-container">
						<div id="slider-banner-fullwidth-big-height" class="slider-banner-fullwidth-big-height rev_slider" data-version="5.0">
							<ul class="slides">
								...
								<!-- main image -->
								<img src="<?=$v['image']?>" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
								...
								<div class="tp-caption large_white"
									...
									data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><?=$v['title']?>
								</div>
			...
			function onSignIn(googleUser) {
			  ...
			  $.post("<?=base_url('api/googlelogin')?>",{"ID":profile.getId(),"Name":profile.getName(),"URL":profile.getImageUrl(),"Email":profile.getEmail()}, function(data){
			  	console.log(data);
			  	//if(data.status == "OK") {
								...
								<div class="tab-pane active" id="pill-1">
									<div class="row masonry-grid-fitrows grid-space-10">
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													...
													<a class="overlay-link popup-img-single" href="<?=base_url('assets/template/images/product-2.jpg')?>"><i class="fa fa-search-plus"></i></a>
													<div class="overlay-to-top links">
														<span class="small">
															<a href="#" class="btn-sm-link"><i class="fa fa-heart-o pr-10"></i>Add to Wishlist</a>
															<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													...
													<a class="overlay-link popup-img-single" href="<?=base_url('assets/template/images/product-3.jpg')?>"><i class="fa fa-search-plus"></i></a>
													<div class="overlay-to-top links">
														<span class="small">
															<a href="#" class="btn-sm-link"><i class="fa fa-heart-o pr-10"></i>Add to Wishlist</a>
															<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													...
													<a class="overlay-link popup-img-single" href="<?=base_url('assets/template/images/product-4.jpg')?>"><i class="fa fa-search-plus"></i></a>
													<div class="overlay-to-top links">
														<span class="small">
															<a href="#" class="btn-sm-link"><i class="fa fa-heart-o pr-10"></i>Add to Wishlist</a>
															<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="<?=base_url('assets/template/images/product-5.jpg')?>" alt="">
													<span class="badge">30% OFF</span>
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="<?=base_url('assets/template/images/product-6.jpg')?>" alt="">
													<span class="badge">50% OFF</span>
													<a class="overlay-link popup-img-single" href="<?=base_url('assets/template/images/product-6.jpg')?>"><i class="fa fa-search-plus"></i></a>
													<div class="overlay-to-top links">
														<span class="small">
															<a href="#" class="btn-sm-link"><i class="fa fa-heart-o pr-10"></i>Add to Wishlist</a>
															<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="<?=base_url('assets/template/images/product-7.jpg')?>" alt="">
													<span class="badge">40% OFF</span>
													<a class="overlay-link popup-img-single" href="<?=base_url('assets/template/images/product-7.jpg')?>"><i class="fa fa-search-plus"></i></a>
													<div class="overlay-to-top links">
														<span class="small">
															<a href="#" class="btn-sm-link"><i class="fa fa-heart-o pr-10"></i>Add to Wishlist</a>
															<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="<?=base_url('assets/template/images/product-8.jpg')?>" alt="">
													<a class="overlay-link popup-img-single" href="<?=base_url('assets/template/images/product-8.jpg')?>"><i class="fa fa-search-plus"></i></a>
													<div class="overlay-to-top links">
														<span class="small">
															<a href="#" class="btn-sm-link"><i class="fa fa-heart-o pr-10"></i>Add to Wishlist</a>
															<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
									...
									<div class="row masonry-grid-fitrows grid-space-10">
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													...
													<a class="overlay-link popup-img-single" href="<?=base_url('assets/template/images/product-1.jpg')?>"><i class="fa fa-search-plus"></i></a>
													<div class="overlay-to-top links">
														<span class="small">
															<a href="#" class="btn-sm-link"><i class="fa fa-heart-o pr-10"></i>Add to Wishlist</a>
															<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="<?=base_url('assets/template/images/product-5.jpg')?>" alt="">
													<a class="overlay-link popup-img-single" href="<?=base_url('assets/template/images/product-5.jpg')?>"><i class="fa fa-search-plus"></i></a>
													<div class="overlay-to-top links">
														<span class="small">
															<a href="#" class="btn-sm-link"><i class="fa fa-heart-o pr-10"></i>Add to Wishlist</a>
															<a href="#" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
			...
			<!-- section start -->
			<!-- ================ -->
			<section class="section dark-translucent-bg pv-40" style="background-image:url('<?=base_url('assets/template/images/shop-banner.jpg')?>');background-position: 50% 32%;">
				<div class="container">
